            ...
            <div class="swiper-slide banner-style-one">
                ...
                <div class="container">
                    <div class="row align-center">
                        <div class="col-xl-7">
                            <div class="content">
                                <h4>Seeds Products</h4>
                                <h2><strong>Agriculture Matter</strong> SRN Seeds</h2>
                                <p>
                                    A better tomorrow starts with SRN Seeds.
                                </p>
                                <div class="button">
            ...
            <div class="row">
                <div class="col-lg-4 fun-fact-style-one">
                    <div class="heading">
                        ...
                        <h2 class="title">Delivering value <br> since 2017</h2>
                    </div>
                </div>
